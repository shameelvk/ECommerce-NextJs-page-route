            ...
            <div className="col-12 col-xl-11">
              ...
              <div className="d-flex mb-5">
                ...
                <div>
                  ...
                  <address className="mb-0 text-secondary">676501 Malappuram Kerala,India</address>
                </div>
              </div>
                ...
                <div className="col-12 col-sm-6">
                  <div className="d-flex mb-5 mb-sm-0">
                    ...
                    <div>
                      ...
                      <p className="mb-0">
                        <a className="link-secondary text-decoration-none" href="tel:+15057922430">(+91) 9429484921</a>
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-12 col-sm-6">
                  <div className="d-flex mb-0">
                    ...
                    <div>
                      ...
                      <p className="mb-0">
                        <a className="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">shameel@gmail.com</a>
                      </p>
                    </div>
                  </div>
                </div>
